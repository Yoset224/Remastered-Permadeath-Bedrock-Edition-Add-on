...
execute @s[tag=!achievementwelcome] ~ ~ ~ tellraw @a {"rawtext": [{"translate":"achievements.text","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.welcomeuser"},{"text":""}]}}]}
tag @s[tag=!achievementwelcome] add achievementwelcome