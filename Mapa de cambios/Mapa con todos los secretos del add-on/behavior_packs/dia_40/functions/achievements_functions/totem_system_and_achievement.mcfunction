...
clear @s totem 1
execute @s[scores={totem=0..96}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"message.totemuse_system","with":{"rawtext":[{"selector":"@s"},{"score":{"name":"@s","objective":"totem"}},{"text":"97"}]}}]}
execute @s[scores={totem=97..}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"message.totemuse_system.kill","with":{"rawtext":[{"selector":"@s"},{"score":{"name":"@s","objective":"totem"}},{"text":"97"}]}}]}
execute @s[scores={totem=97..}] ~ ~ ~ tag @s add totemkill
execute @s[scores={totem=97..}] ~ ~ ~ kill @s
