...
execute @s[tag=!beacon] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text_complete","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.beacon"},{"text":""}]}}]}
execute @s[tag=!beacon] ~ ~ ~ playsound ui.achievement.complete @s
execute @s[tag=!beacon] ~ ~ ~ tag @s add beacon