...
execute @s[tag=!godlol] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text_complete","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.serios"},{"text":""}]}}]}
execute @s[tag=!godlol] ~ ~ ~ playsound ui.achievement.complete @s
execute @s[tag=!godlol] ~ ~ ~ tag @s add godlol