...
execute @s[tag=!killpiglin] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.abdiel_lol"},{"text":""}]}}]}
execute @s[tag=!killpiglin] ~ ~ ~ tag @s add killpiglin