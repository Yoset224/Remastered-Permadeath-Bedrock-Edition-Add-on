...
execute @s[tag=!codcomplete] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.cod_lol"},{"text":""}]}}]}
tag @s add codcomplete