...
execute @s[tag=!shulker] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text_complete","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.shulker"},{"text":""}]}}]}
execute @s[tag=!shulker] ~ ~ ~ playsound ui.achievement.complete @s
execute @s[tag=!shulker] ~ ~ ~ tag @s add shulker