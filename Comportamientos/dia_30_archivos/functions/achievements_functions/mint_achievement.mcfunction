...
execute @s[tag=!mint] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.mint"},{"text":""}]}}]}
execute @s[tag=!mint] ~ ~ ~ tag @s add mint