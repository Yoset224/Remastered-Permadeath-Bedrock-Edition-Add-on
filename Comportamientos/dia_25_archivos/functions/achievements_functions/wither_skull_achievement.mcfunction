...
execute @s[tag=!skull] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.wither_skull"},{"text":""}]}}]}
execute @s[tag=!skull] ~ ~ ~ tag @s add skull