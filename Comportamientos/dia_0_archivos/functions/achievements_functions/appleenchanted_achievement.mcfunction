...
execute @s[tag=!apple] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.apple"},{"text":""}]}}]}
execute @s[tag=!apple] ~ ~ ~ tag @s add apple