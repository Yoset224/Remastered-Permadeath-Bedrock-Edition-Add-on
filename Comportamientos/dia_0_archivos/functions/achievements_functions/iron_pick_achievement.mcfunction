...
execute @s[tag=!ironpick] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.iron_pick"},{"text":""}]}}]}
execute @s[tag=!ironpick] ~ ~ ~ tag @s add ironpick