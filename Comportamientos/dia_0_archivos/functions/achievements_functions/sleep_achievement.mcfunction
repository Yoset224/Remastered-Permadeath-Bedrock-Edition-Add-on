...
execute @s[tag=!death_train_activate] ~ ~ ~ time set 0
execute @s[tag=!death_train_activate] ~ ~ ~ weather clear
execute @s[tag=!death_train_activate] ~ ~ ~ tellraw @a {"rawtext": [{"translate":"player.sleep.correct","with":{"rawtext":[{"selector":"@s"}]}}]}
