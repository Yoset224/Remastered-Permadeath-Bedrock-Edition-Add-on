...
execute @s[tag=!newuser2] ~ ~ ~ scoreboard objectives add TotemHandleTime dummy
execute @s[tag=!newuser2] ~ ~ ~ scoreboard objectives add randomcat dummy
...
execute @s[tag=!newuser2] ~ ~ ~ tag @s add newuser2
