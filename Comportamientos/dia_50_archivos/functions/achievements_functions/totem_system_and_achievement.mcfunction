...
clear @s totem 1
execute @s[scores={totem=0..94}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"message.totemuse_system","with":{"rawtext":[{"selector":"@s"},{"score":{"name":"@s","objective":"totem"}},{"text":"95"}]}}]}
execute @s[scores={totem=95..}] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"message.totemuse_system.kill","with":{"rawtext":[{"selector":"@s"},{"score":{"name":"@s","objective":"totem"}},{"text":"95"}]}}]}
execute @s[scores={totem=95..}] ~ ~ ~ tag @s add totemkill
execute @s[scores={totem=95..}] ~ ~ ~ kill @s
