...
execute @s[tag=!diamonds] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.diamonds"},{"text":""}]}}]}
execute @s[tag=!diamonds] ~ ~ ~ tag @s add diamonds