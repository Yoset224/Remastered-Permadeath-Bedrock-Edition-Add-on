...
execute @s[tag=!nether] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.nether"},{"text":""}]}}]}
execute @s[tag=!nether] ~ ~ ~ tag @s add nether