...
execute @s[tag=!ghastkill] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text_complete","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.ghast_kill"},{"text":""}]}}]}
execute @s[tag=!ghastkill] ~ ~ ~ playsound ui.achievement.complete @s
execute @s[tag=!ghastkill] ~ ~ ~ tag @s add ghastkill