...
execute @s[tag=!armorne] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text_complete","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.netherite"},{"text":""}]}}]}
execute @s[tag=!armorne] ~ ~ ~ playsound ui.achievement.complete @s
execute @s[tag=!armorne] ~ ~ ~ tag @s add armorne