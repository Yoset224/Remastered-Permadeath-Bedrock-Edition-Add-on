...
execute @s[tag=!blazerod] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.blaze_rod"},{"text":""}]}}]}
execute @s[tag=!blazerod] ~ ~ ~ tag @s add blazerod