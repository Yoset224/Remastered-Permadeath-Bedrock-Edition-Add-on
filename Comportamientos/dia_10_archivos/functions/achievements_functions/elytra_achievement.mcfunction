...
execute @s[tag=!elytra] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text_complete","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.sky_limit"},{"text":""}]}}]}
execute @s[tag=!elytra] ~ ~ ~ playsound ui.achievement.complete @s
execute @s[tag=!elytra] ~ ~ ~ tag @s add elytra