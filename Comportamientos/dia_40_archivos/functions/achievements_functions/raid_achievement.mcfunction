...
execute @s[tag=!raid] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.raid"},{"text":""}]}}]}
execute @s[tag=!raid] ~ ~ ~ tag @s add raid