...
execute @s[tag=!hero] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text_complete","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.hero"},{"text":""}]}}]}
execute @s[tag=!hero] ~ ~ ~ playsound ui.achievement.complete @s
execute @s[tag=!hero] ~ ~ ~ tag @s add hero