...
execute @s[tag=!hardware] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.acquire_hardware"},{"text":""}]}}]}
execute @s[tag=!hardware] ~ ~ ~ tag @s add hardware