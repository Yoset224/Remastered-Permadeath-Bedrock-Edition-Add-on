...
execute @s[tag=!stoneage] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.stoneage"},{"text":""}]}}]}
execute @s[tag=!stoneage] ~ ~ ~ tag @s add stoneage