...
execute @s[tag=!armord] ~ ~ ~ tellraw @a {"rawtext":[{"translate":"achievements.text","with":{"rawtext":[{"selector":"@s"},{"translate":"achievements.armor_diamond"},{"text":""}]}}]}
execute @s[tag=!armord] ~ ~ ~ tag @s add armord